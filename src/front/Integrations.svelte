    ...
    <div>
        ...
        <ul style="list-style-type:circle; font-size: 20px;">
            ...
            <li><a href="#/electricity-graph/graficaGrupo2"> Grafica de comparacion de la Api del grupo 2
                    Plugin-Vehicles</a></li>
            <li><a href="#/electricity-graph/graficaGrupo23"> Grafica de comparacion de la Api del grupo 23
                    Cigarrete-Sales</a></li>
            <li><a href="#/electricity-graph/graficaGrupo12"> Grafica de comparacion de la Api del grupo 12
                    Overdose-Deaths</a></li>
            <li><a href="#/electricity-graph/graficaGrupo06"> Grafica de comparacion de la Api del grupo 06
                    Acc-Stats</a></li>
            <li><a href="#/electricity-graph/graficaGrupo24"> Grafica de comparacion de la Api del grupo 24
                    Atc-Stats</a></li>
